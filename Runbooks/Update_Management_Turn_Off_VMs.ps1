...
#Verwijderen tag om geexclude te worden van de Autoscale runbook
$context_MO = ConvertFrom-Json  $SoftwareUpdateConfigurationRunContext
$vmIds_MO = $context_MO.SoftwareUpdateConfigurationSettings.AzureVirtualMachines

$vmIds_MO | ForEach-Object {
    $vmId_MO =  $_
    $split_MO = $vmId_MO -split "/";
    $rg_MO = $split_MO[4];
    $name_MO = $split_MO[8];
